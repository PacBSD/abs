...
+    search->url = "https://bugs.pacbsd.org";
+    search->label_text = "PacBSD";
+    search->size = 10;
...
+        search->url = g_strdup(xfce_rc_read_entry(rcfile,"url","https://bugs.pacbsd.org"));
+        search->label_text = g_strdup(xfce_rc_read_entry(rcfile,"value","PacBSD"));
